...
def getRobotPlacement(q, robot_width, robot_height):
    ...
    vertices = [# coordinates assuming theta is 0 
        [q[0] - robot_width*0.2, q[1] - robot_height*0.5], # bottom left
        # [q[0] + robot_width*0.8, q[1] - robot_height*0.5], # bottom right ....
        # [q[0] + robot_width*0.8, q[1] + robot_height*0.5],
        [q[0] + robot_width*0.8, q[1] ], # bottom right ....
        [q[0] + robot_width*0.8, q[1] ],
        [q[0] - robot_width*0.2, q[1] + robot_height*0.5],
    ]
    ctheta = math.cos(-q[2])
    stheta = math.sin(-q[2])
    points = []
